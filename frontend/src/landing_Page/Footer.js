...
function Footer() {
  return (
    <footer style={{ backgroundColor: "rgb(250, 250, 250)" }}>
      <div className="container border-top mt-5">
        <div className="row mt-5">
          <div className="col-12 col-md-6 col-lg-3 mb-4">
            <img src="media/images/logo.svg" className="footer-brand-logo" alt="TradeNova logo" />
            <p>
      ...
      <div className="riya-signoff-badge">
        Made with <span className="riya-signoff-heart">&#10084;</span> by Riya
      </div>
    </footer>
  );
}
